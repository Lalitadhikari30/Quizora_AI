...
public class AiIntegrationService {
    ...
    private String buildStructuredQuizPrompt(String content, String difficulty, String topics, int questionCount) {
        ...
        return String.format(
            ...
            "First, analyze the content thoroughly. Identify:\n" +
            ...
            "6. Detailed explanation referencing the content\n" +
            "7. Difficulty: %s\n" +
            "8. Topics: %s\n\n" +
            ...
            questionCount, truncatedContent, difficulty, topics, difficulty
        );
    }
